    ...
    <div className={tw(`relative max-w-7xl mx-auto mb-24`)}>
      <div className={tw(`overflow-hidden lg:max-w-none lg:flex`)}>
        <div className={tw(`py-8 px-6 md:px-0 lg:flex-shrink-1`)}>
          <h2 className={tw(`text-4xl lg:text-7xl font-bold text-gray-800 mb-12`)}>free forever</h2>
          <p className={tw(`mt-6 text-base leading-6 text-gray-500`)}>
            our aim is to provide a secure and contributional space in the internet, by making our product accessible to everyone for free of cost.
            <b>just came for exploring, be sure to comeback and grab the lifetime offer.</b>
          </p>
        ...
        >
          <p className={tw(`text-lg font-medium text-gray-800`)}>create an account now...</p>
